...
public class StandardAuthserviceSpec implements Serializable {

    private static final long serialVersionUID = 1L;

    private StandardAuthserviceSpec standardAuthenticationService;
    private NoneAuthserviceSpec noneAuthenticationService;

    private Map<String, Object> additionalProperties = new HashMap<>(0);

    @JsonProperty(required = true)
    public StandardAuthserviceSpec getStandardAuthserviceSpec() {
        return standardAuthserviceSpec;
    }

    public void setStandardAuthserviceSpec(StandardAuthserviceSpec standardAuthserviceSpec) {
        this.standardAuthenticationService = standardAuthserviceSpec;
    }
