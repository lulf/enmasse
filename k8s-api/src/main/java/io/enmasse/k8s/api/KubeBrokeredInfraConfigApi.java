...
public class KubeBrokeredInfraConfigApi implements BrokeredInfraConfigApi, ListerWatcher<BrokeredInfraConfig, BrokeredInfraConfigList> {
    ...
    public KubeBrokeredInfraConfigApi(NamespacedOpenShiftClient client, CustomResourceDefinition addressSpacePlanDefinition) {
        this.client = client;
    ...
    public BrokeredInfraConfigList list(ListOptions listOptions) {
        return client.customResources(addressSpacePlanDefinition, BrokeredInfraConfig.class, BrokeredInfraConfigList.class, DoneableBrokeredInfraConfig.class).list();
    }
    ...
    public io.fabric8.kubernetes.client.Watch watch(io.fabric8.kubernetes.client.Watcher<BrokeredInfraConfig> watcher, ListOptions listOptions) {
        ...
        return client.withRequestConfig(requestConfig).call(c ->
                c.customResources(addressSpacePlanDefinition, BrokeredInfraConfig.class, BrokeredInfraConfigList.class, DoneableBrokeredInfraConfig.class).withResourceVersion(listOptions.getResourceVersion()).watch(watcher));
    }
