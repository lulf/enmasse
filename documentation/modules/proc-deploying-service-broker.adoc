...
The service broker provides an implementation of the Open Service Broker API that integrates with the {PlatformName} Service Catalog. The service broker requires the standard authentication service to be deployed.
